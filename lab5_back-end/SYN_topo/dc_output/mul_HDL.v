...
// Date      : Mon Nov 14 23:59:03 2022
/////////////////////////////////////////////////////////////


module mul_bw16_DW01_add_4 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_5 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_6 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_7 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_8 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_9 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_10 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_11 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_12 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16_DW01_add_13 ( A, B, CI, SUM, CO );
  input [31:0] A;
  input [31:0] B;
  output [31:0] SUM;
  input CI;
...
module mul_bw16 ( CLK, RESETn, a, b, y );
  input [15:0] a;
  input [15:0] b;
  output [31:0] y;
  input CLK, RESETn;
  ...
  mul_bw16_DW01_add_4 add_30_G12 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, N1175, 
  ...
  mul_bw16_DW01_add_5 add_30_G11 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
  ...
  mul_bw16_DW01_add_6 add_30_G10 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        ...
        N971, N970, N969}) );
  mul_bw16_DW01_add_7 add_30_G9 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, N863, N862, N861, N860, N859, N858, N857, N856, N855, N854, N853, 
        N852, N851, N850, N849, N848, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .B({\partials[7][31] , \partials[7][30] , \partials[7][29] , 
        ...
        \partials[7][7] , \partials[7][6] , \partials[7][5] , \partials[7][4] , 
        \partials[7][3] , \partials[7][2] , \partials[7][1] , \partials[7][0] }), .CI(1'b0), .SUM({N895, N894, N893, N892, N891, N890, N889, N888, N887, N886, 
        N885, N884, N883, N882, N881, N880, N879, N878, N877, N876, N875, N874, 
        N873, N872, N871, N870, N869, N868, N867, N866, N865, N864}) );
  mul_bw16_DW01_add_8 add_30_G8 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, N757, N756, N755, N754, N753, N752, N751, N750, N749, N748, 
        N747, N746, N745, N744, N743, N742, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .B({\partials[6][31] , \partials[6][30] , \partials[6][29] , 
        \partials[6][28] , \partials[6][27] , \partials[6][26] , 
        \partials[6][25] , \partials[6][24] , \partials[6][23] , 
        \partials[6][22] , \partials[6][21] , \partials[6][20] , 
        \partials[6][19] , \partials[6][18] , \partials[6][17] , 
        ...
        \partials[6][13] , \partials[6][12] , \partials[6][11] , 
        \partials[6][10] , \partials[6][9] , \partials[6][8] , 
        \partials[6][7] , \partials[6][6] , \partials[6][5] , \partials[6][4] , 
        \partials[6][3] , \partials[6][2] , \partials[6][1] , \partials[6][0] }), .CI(1'b0), .SUM({N789, N788, N787, N786, N785, N784, N783, N782, N781, N780, 
        N779, N778, N777, N776, N775, N774, N773, N772, N771, N770, N769, N768, 
        N767, N766, N765, N764, N763, N762, N761, N760, N759, N758}) );
  mul_bw16_DW01_add_9 add_30_G7 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0, 1'b0, 1'b0, N650, N649, N648, N647, N646, N645, N644, N643, N642, 
        N641, N640, N639, N638, N637, N636, N635, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        1'b0}), .B({\partials[5][31] , \partials[5][30] , \partials[5][29] , 
        \partials[5][28] , \partials[5][27] , \partials[5][26] , 
        \partials[5][25] , \partials[5][24] , \partials[5][23] , 
        \partials[5][22] , \partials[5][21] , \partials[5][20] , 
        \partials[5][19] , \partials[5][18] , \partials[5][17] , 
        \partials[5][16] , \partials[5][15] , \partials[5][14] , 
        \partials[5][13] , \partials[5][12] , \partials[5][11] , 
        \partials[5][10] , \partials[5][9] , \partials[5][8] , 
        \partials[5][7] , \partials[5][6] , \partials[5][5] , \partials[5][4] , 
        \partials[5][3] , \partials[5][2] , \partials[5][1] , \partials[5][0] }), .CI(1'b0), .SUM({N682, N681, N680, N679, N678, N677, N676, N675, N674, N673, 
        N672, N671, N670, N669, N668, N667, N666, N665, N664, N663, N662, N661, 
        N660, N659, N658, N657, N656, N655, N654, N653, N652, N651}) );
  mul_bw16_DW01_add_10 add_30_G6 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        ...
        N545, N544, N543}) );
  mul_bw16_DW01_add_11 add_30_G5 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        ...
        N436, N435, N434}) );
  mul_bw16_DW01_add_12 add_30_G4 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
        ...
        N326, N325, N324}) );
  mul_bw16_DW01_add_13 add_30_G3 ( .A({1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 1'b0, 
