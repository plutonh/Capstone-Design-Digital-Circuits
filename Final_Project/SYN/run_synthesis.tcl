...
elaborate -architecture verilog -library WORK mul_A
current_design mul_A
...
# save results
write -f ddc -hierarchy -output results/mul_A.ddc
write -hierarchy -format verilog -output results/mul_A.mapped.v
write_sdc results/mul_A.sdc -version 2.1
write_sdf results/mul_A.sdf
