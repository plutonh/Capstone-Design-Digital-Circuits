...
# Created by write_sdc for scenario [mode_norm.OC_rvt_ss0p95v125c] on Mon Oct 3 17:19:15 2022
...
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {c[2]}]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {c[1]}]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {c[0]}]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {d[2]}]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {d[1]}]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p95v125c -pin Y -no_design_rule [get_ports {d[0]}]
